<template>
  <div class="min-h-screen bg-gray-100 font-sans">
    ...
    <div class="flex">
      <Sidebar />
      <div class="flex-1 bg-blue-50 pl-64 pt-20">
        <div class="max-w-7xl mx-auto px-8">
          <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
            <div>
              <h2 class="text-3xl font-bold text-gray-800 mb-1">Good Morning, Shijra</h2>
              <p class="text-gray-500 text-lg">Monday, 20-August-2024</p>
            </div>
